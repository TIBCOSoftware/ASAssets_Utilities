...
public class RegexPosition implements CustomProcedure {
  protected ExecutionEnvironment qenv;
  private int result = 0;

  public RegexPosition() {}
  ...
  public void invoke (Object[] inputValues) throws CustomProcedureException, SQLException {
    ...
    try {
      ...
      if (occurrence == 0)
        throw new Exception ("Input Value for \"Occurrence\" must not be zero.");
  ...
  public String getDescription() {
    return "Custom procedure to find the position of an occurrence of a regular expression in an input string";
  }
