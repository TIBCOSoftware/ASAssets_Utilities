package com.tibco.ps.utils.xml;
...
/* 
	DeleteElementSpareChildren:
	
	This CJP removes an element from an XML structure and moves it's children under the element's parent.
...
public class DeleteElementSpareChildren implements CustomProcedure {
  ...
  public DeleteElementSpareChildren() {}
  ...
  public void invoke (Object[] inputValues) throws CustomProcedureException, SQLException {
    ...
    try {
      ...
      //
      qenv.log (LOG_DEBUG, className + ": Getting element's children");
      ...
      if (children != null) {
        for (int i = children.getLength() - 1; i >= 0; i--) {
          ...
          qenv.log (LOG_INFO, className + ": removing {" + children.item(i).getNamespaceURI() + "}" + children.item(i).getLocalName() + " from {" + e.getNamespaceURI() + "}" + e.getLocalName());
      ...
      // reverse the order of the children again so they go onto the new element in the correct order
      //
      qenv.log (LOG_DEBUG, className + ": Reataching children to parent");
      for (int i = c.size() - 1; i >= 0; i--) {
        p.appendChild ((Node) c.get (i));
      }
  ...
  public String getName() {
    return "DeleteElementSpareChildren";
  }
  ...
  public String getDescription() {
    return "Custom procedure to remove an element from an XML structure, yet preserve it's children by moving them under the parent.";
  }
