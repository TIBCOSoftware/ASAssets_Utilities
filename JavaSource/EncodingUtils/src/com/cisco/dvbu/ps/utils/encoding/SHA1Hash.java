...
SHA1Hash:
	...
	Input:
		inputString - The string to apply the SHA1 hash to.  
			Values: Any text value


	Output:
		result - The input string with the MD5 hash applied
			Values: An SHA1 hash string.
...
public class SHA1Hash implements CustomProcedure {
	...
	public String getDescription() {
		return "This procedure generates an SHA1 hash from the input string";
	}
