...
/*
 * Source File: CreateFileBinary.java
 *
 * Description: This Composite CJP creates a new Binary file in the file system.
 *
 ...
 *		fileContent - The binary content to write.							createLongVarBinary("fileContent", DIRECTION_IN, 2147483647)
 *
 *	Output: none
 *
...
public class CreateFileBinary implements CustomProcedure, java.io.Serializable {
...
return "This Composite CJP creates a new Binary file in the file system";
}
...
public ParameterInfo[] getParameterInfo() {
    return new ParameterInfo[] {
            ...
            new ParameterInfo("append", Types.SMALLINT, DIRECTION_IN),
 		    ParameterInfo.createLongVarBinary("fileContent", DIRECTION_IN, 2147483647)
            };
}
...
public void createFileBinary(String fileName, boolean append, byte[] fileContent) 
			...
			try
			{
				...
				DataOutputStream out = new DataOutputStream(new FileOutputStream( fileName, append ) );		    
...
public static void main(String[] args) {
	CustomProcedure cp = new CreateFileBinary();
	String param1 = "/tmp/test_new.dat";
	int param2 = 0; //0=do not append file, 1=append file
	String param3 = "binary content for line 1";
